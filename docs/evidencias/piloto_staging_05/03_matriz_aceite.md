...
| 2 | Auditoria | correlation_id propagado agenda/outbox | OK | `request-correlation.ts`, rotas agenda |
| 2 | Auditoria | UI read-only `/operacao/auditoria` | OK | `OperationalAuditPage.tsx` |
| 2 | Auditoria | Filtros utilizador/ação/entidade/correlation/período | OK | API + Web |
...
| 2 | Auditoria | Aceite PO / merge | OK | PR #9 merge `a0f47db` em `piloto-staging-01` — `22_merge_pr9_piloto_staging_01.md` |
