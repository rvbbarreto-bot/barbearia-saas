...
**Fase P2 (MVP operacional / piloto controlado):** P2.1 fechada no tip `f57b1a3` da branch `feature/p2-operational-mvp-pilot`. **Entrega actual (P2.2 / P2.3 — Grande Pacote Operacional):** branch **`feature/p2-2-web-outbox-whatsapp-operational`**, âmbito `docs/P2_2_PORTAL_OPERACIONAL.md`, kickoff §10 em `docs/P2_RELATORIO_MVP_OPERACIONAL.md`. Relatório mestre `docs/P2_RELATORIO_MVP_OPERACIONAL.md`; decisões `docs/P2_DECISOES_PRODUTO.md`; QA `docs/P2_QA_EXECUCAO.md` (P2.1: `scripts/qa-api-p2-operational-battery.ps1`, `docs/QA_API_P2_OPERATIONAL_RESULTS.csv`; **P2.2.1:** `scripts/qa-p2-2-web-outbox-whatsapp-battery.ps1`, `docs/QA_API_P2_2_OPERATIONAL_RESULTS.csv`; **P2.3:** `scripts/qa-p2-3-operational-assisted-battery.ps1`, `docs/QA_API_P2_3_OPERATIONAL_ASSISTED_RESULTS.csv`); runbook `docs/P2_RUNBOOK_SUPORTE.md`; WhatsApp/n8n `docs/P2_FLUXO_WHATSAPP_N8N.md`; outbox `docs/P2_OUTBOX_OPERACIONAL.md`; appointments `docs/P2_APPOINTMENT_LIFECYCLE.md`; operação assistida `docs/P2_3_OPERACAO_ASSISTIDA.md`.

**GATE 0 (fecho formal P2.2.1):** executar a bateria P2.2.1 em Docker real, actualizar o CSV, anexar evidências em `docs/P2_2_EVIDENCIAS_PORTAL_OUTBOX.md` e capturas em `docs/evidencias/gate0_p2_2_1/` (ver índice nesse directório). P2.3: `docs/P2_3_OPERACAO_ASSISTIDA.md`.
